...
import com.tlchain.jsonrpc.JsonCallSerializer;
import com.tlchain.jsonrpc.JsonParser;
...
public final class HttpClient {
	...
	public static String execute(final JsonCall call) throws Exception {
		return execute("https://mainnet-rpc.tlxscan.com/", call);
	}
